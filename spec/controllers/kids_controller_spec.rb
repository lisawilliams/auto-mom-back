...
RSpec.describe KidsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested kid as @kid" do
      kid = Kid.create! valid_attributes
      get :show, params: {id: kid.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested kid as @kid" do
      kid = Kid.create! valid_attributes
      get :edit, params: {id: kid.to_param}, session: valid_session
      expect(assigns(:kid)).to eq(kid)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Kid" do
        expect {
          post :create, params: {kid: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved kid as @kid" do
        post :create, params: {kid: invalid_attributes}, session: valid_session
        expect(assigns(:kid)).to be_a_new(Kid)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested kid" do
        kid = Kid.create! valid_attributes
        put :update, params: {id: kid.to_param, kid: new_attributes}, session: valid_session
        kid.reload
      ...
      it "assigns the requested kid as @kid" do
        kid = Kid.create! valid_attributes
        put :update, params: {id: kid.to_param, kid: valid_attributes}, session: valid_session
        expect(assigns(:kid)).to eq(kid)
      end
    ...
    context "with invalid params" do
      it "assigns the kid as @kid" do
        kid = Kid.create! valid_attributes
        put :update, params: {id: kid.to_param, kid: invalid_attributes}, session: valid_session
        expect(assigns(:kid)).to eq(kid)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested kid" do
      kid = Kid.create! valid_attributes
      expect {
        delete :destroy, params: {id: kid.to_param}, session: valid_session
      }.to change(Kid, :count).by(-1)
    end
